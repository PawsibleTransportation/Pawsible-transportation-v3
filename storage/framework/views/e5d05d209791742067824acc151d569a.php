        ...
        <?php $__currentLoopData = $reviews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <li class="list-row">
                <div><img class="size-10 rounded-box"
                        src="<?php echo e($r->gender == 'male' ? $malePlaceholder : $femalePlaceholder); ?>" />
                </div>
                <div>
                    <div><?php echo e($r->name); ?></div>
                    <div class="text-xs uppercase font-semibold opacity-60"><?php echo e($r->dest); ?></div>
                </div>
...
</div><?php /**PATH /home/itsmenewbie03/Desktop/WareHouse/PHP/Laravel/pawsible-transportation-v2/resources/views/livewire/reviews/index.blade.php ENDPATH**/ ?>